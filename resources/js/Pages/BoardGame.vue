        ...
        <main>
            ...
            <div class="row row-cols-1 row-cols-md-3 mb-3 text-center">
                ...
                <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm">                     
                        <div class="card-header py-3">
                            <h4 class="my-0 fw-normal text-dark" v-if="shift == true">Haz tu jugada</h4>
...
<script >
    ...
    export default {
        ...
        mounted(){
            ...
            setInterval(()=> {this.updateInfoGame()}, 2000);
        ...
        methods:{
            ...
            play(pos)
            {
                ...
                if(this.board[pos] >= 1)
                {
                    // this.board[pos]=this.first_player_id;
                }else{
                    this.board[pos]=this.first_player_id;
                }
            },
            ...
            updateInfoGame()
            {
                ...
                axios.get('get-info-update-game/'+this.code)
                .then(response => {
