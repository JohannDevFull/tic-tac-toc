...
*/
    ...
    Route::post('/update-name',                             [TictactocController::class, 'updateName']);
    Route::post('/new-game',                                [TictactocController::class, 'newGame']);

    Route::post('/send-request',  	                        [TictactocController::class, 'requestGame']);
